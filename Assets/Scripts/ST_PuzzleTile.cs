...
public class ST_PuzzleTile : MonoBehaviour
{
    ...
    public IEnumerator UpdatePosition()
    {
        ...
        while (Vector3.Distance(this.transform.localPosition, TargetPosition) > 0.01f)
        {
        ...
        // Now that we've reached the target position, check if we are in the correct location.
        CorrectLocation = (ArrayLocation == GridLocation);
